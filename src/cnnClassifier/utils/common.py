...
def create_directories(path_to_directories: list, verbose = True):
    ...
    Args:
        path_to_directories (list): of path dierctories
        ignore_log (bool, eptional): ignore if nultiple dires is to be created. Defaults to False.
    """
...
def load_bin(path: Path) -> Any:
    ...
    Args:
        path (Path): pathto binary file

    Returns:
        Any: object store inthe file
    """
